  ...
  items: [
    {
      ...
      category: "Website tour du lịch",
      price: "11,5 triệu",
      priceUnit: "Giá/gói",
      statusBadge: "Đã hoàn thành & đang hoạt động",
      scopeTitle: "Phạm vi thực hiện:",
      scopeItems: [
        "Tái cấu trúc giao diện đặt tour Hà Giang Loop, chuẩn hóa hiển thị trên Mobile",
        "Tối ưu danh mục tour, bảng lịch trình chi tiết và tích hợp form đặt chỗ nhanh",
        "Tích hợp kết nối WhatsApp & Email tự động tiếp nhận booking khách quốc tế",
        "Dọn dẹp mã nguồn, nén asset hình ảnh phong cảnh tăng tốc độ tải trang toàn cầu",
      ],
    ...
    },
    {
      ...
      category: "Website in ấn & bao bì",
      price: "3,5 triệu",
      priceUnit: "Giá/gói",
      statusBadge: "Đã hoàn thành & đã thanh toán",
      scopeTitle: "Phạm vi thực hiện:",
      scopeItems: [
        "Tái cấu trúc giao diện danh mục sản phẩm in ấn, bao bì và bảng thông số",
        "Tối ưu hiển thị mobile/tablet, xử lý dứt điểm tràn layout và vỡ khung",
        "Tích hợp form báo giá tự động gửi thông tin về email phòng kinh doanh",
        "Dọn dẹp mã nguồn cũ, nén asset hình ảnh sản phẩm tăng tốc tải trang",
      ],
      notice: "Website đã hoàn thành, đã thanh toán và đang hoạt động ổn định.",
    },
  ],
};
